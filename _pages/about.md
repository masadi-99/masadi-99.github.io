...
I'm a PhD student in Electrical Engineering at Stanford, where I work in the [Ashley Lab](https://ashleylab.stanford.edu/), advised by Euan Ashley and co-advised by Fei-Fei Li and Ehsan Adeli. I build multimodal models for cardiology that read ECG, echocardiograms, and cardiac MRI, and I study where frontier multimodal models fail. In [MIRAGE](/mirage/), we found that they will confidently diagnose medical images they were never shown.
...
{% include press_list.liquid limit=3 %}
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    "@type": "Person",
    "@id": "https://masadi.ai/#mohammad-asadi",
    "name": "Mohammad Asadi",
    "givenName": "Mohammad",
    "familyName": "Asadi",
    ...
    "url": "https://masadi.ai/",
    "image": "https://masadi.ai/assets/img/prof_pic.jpg",
    ...
    "knowsAbout": [
      ...
      "AI in Medicine", "Cardiology", "Medical Imaging", "Electrocardiography", "Echocardiography", "Cardiac MRI"
    ],
    "sameAs": [
      "https://scholar.google.com/citations?user=cRuOHB0AAAAJ&hl=en",
      "https://github.com/masadi-99",
      "https://www.linkedin.com/in/mohammad-asadi-9a7b6b191/",
      "https://hai.stanford.edu/people/mohammad-asadi",
      "https://profiles.stanford.edu/mohammad-asadi"
    ]
  }
}
</script>
